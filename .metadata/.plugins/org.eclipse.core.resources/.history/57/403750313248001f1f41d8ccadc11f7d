...
<body>
	...
	<div class="container mt-5">
			...
			<tbody>
				<c:forEach var="customer" items="${theCustomerList}">
					...
					<tr>
						...
						<td><a
							href="AdminController?action=editCustomer&Id=${customer.getId()}"
							class="btn btn-secondary">Update</a></td>

						<td><a
							href="AdminController?action=delete&Id=${customer.getId()}"
		...
		<a href="admin-add-new-Customers.jsp" class="btn btn-primary mt-3">Add
			New Customer</a>
